...
namespace Parcel_Delivery_Management_System
{
    class DBAccess
    {
        ...
        private static string strConnString = @"Data Source=Mahib\SQLEXPRESS;Initial Catalog=Final_DataBase 2 (1);Integrated Security=True;Encrypt=False;TrustServerCertificate=True";
